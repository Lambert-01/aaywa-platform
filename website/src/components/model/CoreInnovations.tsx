    ...
    const innovations: Innovation[] = [
        {
            ...
            description: 'A dignified partnership, not charity. Net profits are split equally between farmers and the enterprise.',
            icon: (
        ...
        {
            title: 'Organic Fertilizer Core',
            description: 'Compost is our central strategy—regenerating soil health while boosting crop yields sustainably.',
            icon: (
                <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        {
            title: 'VSLA Integration',
            description: 'Financial inclusion built-in. Village Savings and Loan Associations empower saving and lending.',
            icon: (
                <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        {
            title: 'Avocado Focus',
            description: 'High-value crop (Hass variety) intercropped for short-term food security and long-term profit.',
            icon: (
                <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        },
        {
            ...
            description: 'Modern post-harvest management reduces losses and ensures premium quality for market.',
            icon: (
                <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        {
            title: 'Champion Cascade',
            description: 'Peer-to-peer scaling where successful farmers train others, multiplying our impact.',
            icon: (
                <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="container mx-auto px-6">
                <div className="text-center mb-16">
                    ...
                    <p className="text-gray-400 max-w-2xl mx-auto font-light">
                        Our model works because it addresses every aspect of the value chain.
                    </p>
                </div>
