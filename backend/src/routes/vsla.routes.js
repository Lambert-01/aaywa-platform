...
router.get('/', authorizeRoles('project_manager', 'agronomist', 'vsla_officer', 'field_facilitator'), vslaController.getAllVSLAs);
...
// Members & Officers
router.post('/:id/members', authorizeRoles('project_manager', 'agronomist', 'field_facilitator'), vslaController.addMember);
...
// Transactions
router.post('/:id/transactions', authorizeRoles('vsla_officer', 'project_manager', 'field_facilitator'), vslaController.createTransaction);
router.get('/:id/transactions', vslaController.getTransactions);
router.get('/:id/balance', vslaController.getBalance);

// Quick Actions
router.post('/:id/statements/generate', authorizeRoles('project_manager', 'agronomist', 'field_facilitator'), vslaController.generateStatements);
router.post('/:id/summary/email', authorizeRoles('project_manager', 'agronomist', 'field_facilitator'), vslaController.sendWeeklySummary);
router.put('/:id/settings', authorizeRoles('project_manager', 'agronomist'), vslaController.updateSettings);
