...
class Farmer extends DataClass implements Insertable<Farmer> {
  ...
  Farmer copyWithCompanion(FarmersCompanion data) {
    return Farmer(
      ...
      vslaId: data.vslaId.present ? data.vslaId.value : this.vslaId,
      householdType: data.householdType.present
          ? data.householdType.value
          : this.householdType,
      landSizeHa:
          data.landSizeHa.present ? data.landSizeHa.value : this.landSizeHa,
      plotBoundaryCoordinates: data.plotBoundaryCoordinates.present
          ? data.plotBoundaryCoordinates.value
          : this.plotBoundaryCoordinates,
      locationStr:
      ...
      serverUpdatedAt: data.serverUpdatedAt.present
          ...
          : this.serverUpdatedAt,
      lastFailureReason: data.lastFailureReason.present
          ? data.lastFailureReason.value
          : this.lastFailureReason,
    );
  }
...
class Sale extends DataClass implements Insertable<Sale> {
  ...
  Sale copyWithCompanion(SalesCompanion data) {
    return Sale(
      ...
      farmerSplitAmount: data.farmerSplitAmount.present
          ? data.farmerSplitAmount.value
          : this.farmerSplitAmount,
      sanzaSplitAmount: data.sanzaSplitAmount.present
          ? data.sanzaSplitAmount.value
          : this.sanzaSplitAmount,
      inputDeductionAmount: data.inputDeductionAmount.present
          ? data.inputDeductionAmount.value
          : this.inputDeductionAmount,
...
class InputInvoice extends DataClass implements Insertable<InputInvoice> {
  ...
  InputInvoice copyWithCompanion(InputInvoicesCompanion data) {
    return InputInvoice(
      id: data.id.present ? data.id.value : this.id,
      remoteId: data.remoteId.present ? data.remoteId.value : this.remoteId,
      farmerId: data.farmerId.present ? data.farmerId.value : this.farmerId,
...
class AttendanceData extends DataClass implements Insertable<AttendanceData> {
  ...
  AttendanceData copyWithCompanion(AttendanceCompanion data) {
    return AttendanceData(
      ...
      remoteId: data.remoteId.present ? data.remoteId.value : this.remoteId,
      trainingIds:
          data.trainingIds.present ? data.trainingIds.value : this.trainingIds,
      farmerId: data.farmerId.present ? data.farmerId.value : this.farmerId,
      type: data.type.present ? data.type.value : this.type,
...
class PlotBoundary extends DataClass implements Insertable<PlotBoundary> {
  ...
  PlotBoundary copyWithCompanion(PlotBoundariesCompanion data) {
    return PlotBoundary(
      id: data.id.present ? data.id.value : this.id,
      remoteId: data.remoteId.present ? data.remoteId.value : this.remoteId,
      farmerId: data.farmerId.present ? data.farmerId.value : this.farmerId,
...
class $$FarmersTableFilterComposer
  ...
  ColumnFilters<String> get vslaId => $composableBuilder(
      column: $table.vslaId, builder: (column) => ColumnFilters(column));

  ColumnFilters<String> get householdType => $composableBuilder(
      column: $table.householdType, builder: (column) => ColumnFilters(column));

  ColumnFilters<double> get landSizeHa => $composableBuilder(
      column: $table.landSizeHa, builder: (column) => ColumnFilters(column));

  ColumnFilters<String> get plotBoundaryCoordinates => $composableBuilder(
      column: $table.plotBoundaryCoordinates,
  ...
  ColumnFilters<String> get lastFailureReason => $composableBuilder(
      column: $table.lastFailureReason,
      builder: (column) => ColumnFilters(column));
}
...
class $$FarmersTableOrderingComposer
  ...
  ColumnOrderings<String> get vslaId => $composableBuilder(
      column: $table.vslaId, builder: (column) => ColumnOrderings(column));

  ColumnOrderings<String> get householdType => $composableBuilder(
      column: $table.householdType,
  ...
  ColumnOrderings<String> get plotBoundaryCoordinates => $composableBuilder(
      column: $table.plotBoundaryCoordinates,
      builder: (column) => ColumnOrderings(column));
  ...
  ColumnOrderings<String> get lastFailureReason => $composableBuilder(
      column: $table.lastFailureReason,
      builder: (column) => ColumnOrderings(column));
}
...
class $$FarmersTableAnnotationComposer
  ...
  GeneratedColumn<String> get vslaId =>
      $composableBuilder(column: $table.vslaId, builder: (column) => column);

  GeneratedColumn<String> get householdType => $composableBuilder(
      column: $table.householdType, builder: (column) => column);

  GeneratedColumn<double> get landSizeHa => $composableBuilder(
      column: $table.landSizeHa, builder: (column) => column);

  GeneratedColumn<String> get plotBoundaryCoordinates => $composableBuilder(
      column: $table.plotBoundaryCoordinates, builder: (column) => column);
  ...
  GeneratedColumn<String> get lastFailureReason => $composableBuilder(
      column: $table.lastFailureReason, builder: (column) => column);
}
  ...
  $$FarmersTableTableManager(_$AppDatabase db, $FarmersTable table)
      : super(TableManagerState(
          ...
          updateCompanionCallback: ({
            ...
            plotBoundaryCoordinates: plotBoundaryCoordinates,
...
class $$SalesTableFilterComposer extends Composer<_$AppDatabase, $SalesTable> {
  ...
  ColumnFilters<double> get farmerSplitAmount => $composableBuilder(
      column: $table.farmerSplitAmount,
      builder: (column) => ColumnFilters(column));

  ColumnFilters<double> get sanzaSplitAmount => $composableBuilder(
      column: $table.sanzaSplitAmount,
      builder: (column) => ColumnFilters(column));

  ColumnFilters<double> get inputDeductionAmount => $composableBuilder(
      column: $table.inputDeductionAmount,
      builder: (column) => ColumnFilters(column));
...
class $$SalesTableOrderingComposer
  ...
  ColumnOrderings<double> get farmerSplitAmount => $composableBuilder(
      column: $table.farmerSplitAmount,
      builder: (column) => ColumnOrderings(column));

  ColumnOrderings<double> get sanzaSplitAmount => $composableBuilder(
      column: $table.sanzaSplitAmount,
      builder: (column) => ColumnOrderings(column));

  ColumnOrderings<double> get inputDeductionAmount => $composableBuilder(
      column: $table.inputDeductionAmount,
      builder: (column) => ColumnOrderings(column));
...
class $$SalesTableAnnotationComposer
  ...
  GeneratedColumn<double> get farmerSplitAmount => $composableBuilder(
      column: $table.farmerSplitAmount, builder: (column) => column);

  GeneratedColumn<double> get sanzaSplitAmount => $composableBuilder(
      column: $table.sanzaSplitAmount, builder: (column) => column);

  GeneratedColumn<double> get inputDeductionAmount => $composableBuilder(
      column: $table.inputDeductionAmount, builder: (column) => column);
  ...
  $$SalesTableTableManager(_$AppDatabase db, $SalesTable table)
      : super(TableManagerState(
          ...
          updateCompanionCallback: ({
            ...
            Value<double> farmerSplitAmount = const Value.absent(),
            Value<double> sanzaSplitAmount = const Value.absent(),
            Value<double> inputDeductionAmount = const Value.absent(),
            ...
            farmerSplitAmount: farmerSplitAmount,
            sanzaSplitAmount: sanzaSplitAmount,
            inputDeductionAmount: inputDeductionAmount,
...
typedef $$SalesTableProcessedTableManager = ProcessedTableManager<
    ...
    Sale,
    PrefetchHooks Function()>;
typedef $$InputInvoicesTableCreateCompanionBuilder = InputInvoicesCompanion
    Function({
  Value<int> id,
  Value<String?> remoteId,
  required String farmerId,
...
typedef $$InputInvoicesTableUpdateCompanionBuilder = InputInvoicesCompanion
    Function({
  Value<int> id,
  Value<String?> remoteId,
  Value<String> farmerId,
...
class $$InputInvoicesTableFilterComposer
    extends Composer<_$AppDatabase, $InputInvoicesTable> {
  $$InputInvoicesTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$InputInvoicesTableOrderingComposer
    extends Composer<_$AppDatabase, $InputInvoicesTable> {
  $$InputInvoicesTableOrderingComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$InputInvoicesTableAnnotationComposer
    extends Composer<_$AppDatabase, $InputInvoicesTable> {
  $$InputInvoicesTableAnnotationComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$InputInvoicesTableTableManager extends RootTableManager<
    _$AppDatabase,
    $InputInvoicesTable,
    InputInvoice,
    $$InputInvoicesTableFilterComposer,
    $$InputInvoicesTableOrderingComposer,
    $$InputInvoicesTableAnnotationComposer,
    $$InputInvoicesTableCreateCompanionBuilder,
    $$InputInvoicesTableUpdateCompanionBuilder,
    (
      InputInvoice,
      BaseReferences<_$AppDatabase, $InputInvoicesTable, InputInvoice>
    ),
    InputInvoice,
    PrefetchHooks Function()> {
  $$InputInvoicesTableTableManager(_$AppDatabase db, $InputInvoicesTable table)
      : super(TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
              $$InputInvoicesTableFilterComposer($db: db, $table: table),
          createOrderingComposer: () =>
              $$InputInvoicesTableOrderingComposer($db: db, $table: table),
          createComputedFieldComposer: () =>
              $$InputInvoicesTableAnnotationComposer($db: db, $table: table),
          updateCompanionCallback: ({
            Value<int> id = const Value.absent(),
            Value<String?> remoteId = const Value.absent(),
            Value<String> farmerId = const Value.absent(),
...
typedef $$InputInvoicesTableProcessedTableManager = ProcessedTableManager<
    _$AppDatabase,
    $InputInvoicesTable,
    InputInvoice,
    $$InputInvoicesTableFilterComposer,
...
class $$VSLATransactionsTableTableManager extends RootTableManager<
    ...
    (
      VSLATransaction,
      BaseReferences<_$AppDatabase, $VSLATransactionsTable, VSLATransaction>
    ),
    VSLATransaction,
    PrefetchHooks Function()> {
...
class $$AttendanceTableFilterComposer
  ...
  ColumnFilters<String> get trainingIds => $composableBuilder(
      column: $table.trainingIds, builder: (column) => ColumnFilters(column));
...
class $$AttendanceTableOrderingComposer
  ...
  ColumnOrderings<String> get trainingIds => $composableBuilder(
      column: $table.trainingIds, builder: (column) => ColumnOrderings(column));
...
class $$AttendanceTableAnnotationComposer
  ...
  GeneratedColumn<String> get trainingIds => $composableBuilder(
      column: $table.trainingIds, builder: (column) => column);
...
typedef $$AttendanceTableProcessedTableManager = ProcessedTableManager<
    ...
    AttendanceData,
    PrefetchHooks Function()>;
typedef $$PlotBoundariesTableCreateCompanionBuilder = PlotBoundariesCompanion
    Function({
  Value<int> id,
  Value<String?> remoteId,
  required String farmerId,
...
typedef $$PlotBoundariesTableUpdateCompanionBuilder = PlotBoundariesCompanion
    Function({
  Value<int> id,
  Value<String?> remoteId,
  Value<String> farmerId,
...
class $$PlotBoundariesTableFilterComposer
    extends Composer<_$AppDatabase, $PlotBoundariesTable> {
  $$PlotBoundariesTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$PlotBoundariesTableOrderingComposer
    extends Composer<_$AppDatabase, $PlotBoundariesTable> {
  $$PlotBoundariesTableOrderingComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$PlotBoundariesTableAnnotationComposer
    extends Composer<_$AppDatabase, $PlotBoundariesTable> {
  $$PlotBoundariesTableAnnotationComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$PlotBoundariesTableTableManager extends RootTableManager<
    _$AppDatabase,
    $PlotBoundariesTable,
    PlotBoundary,
    $$PlotBoundariesTableFilterComposer,
    $$PlotBoundariesTableOrderingComposer,
    $$PlotBoundariesTableAnnotationComposer,
    $$PlotBoundariesTableCreateCompanionBuilder,
    $$PlotBoundariesTableUpdateCompanionBuilder,
    (
      PlotBoundary,
      BaseReferences<_$AppDatabase, $PlotBoundariesTable, PlotBoundary>
    ),
    PlotBoundary,
    PrefetchHooks Function()> {
  $$PlotBoundariesTableTableManager(
      _$AppDatabase db, $PlotBoundariesTable table)
      : super(TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
              $$PlotBoundariesTableFilterComposer($db: db, $table: table),
          createOrderingComposer: () =>
              $$PlotBoundariesTableOrderingComposer($db: db, $table: table),
          createComputedFieldComposer: () =>
              $$PlotBoundariesTableAnnotationComposer($db: db, $table: table),
          updateCompanionCallback: ({
            Value<int> id = const Value.absent(),
            Value<String?> remoteId = const Value.absent(),
            Value<String> farmerId = const Value.absent(),
...
typedef $$PlotBoundariesTableProcessedTableManager = ProcessedTableManager<
    _$AppDatabase,
    $PlotBoundariesTable,
    PlotBoundary,
    $$PlotBoundariesTableFilterComposer,
...
class $AppDatabaseManager {
  ...
  $$InputInvoicesTableTableManager get inputInvoices =>
      $$InputInvoicesTableTableManager(_db, _db.inputInvoices);
  ...
  $$PlotBoundariesTableTableManager get plotBoundaries =>
      $$PlotBoundariesTableTableManager(_db, _db.plotBoundaries);
}
